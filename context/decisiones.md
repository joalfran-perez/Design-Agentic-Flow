...
| 020 | Registrar la revisión visual de ModUSS Planner vs. Kit Digital (grabación 2026-09-02) como inventario `V*` aparte del funcional `D*`/`U*` | Un solo hablante, transcripción sin marcas intermedias; 33 desvíos, tabs dados por correctos; refuerza la brecha Desktop de `018`; la norma de arreglo es `kitdigital-v1.md` no v2 | `decisions/020-planner-visual-kit-review.md` |
